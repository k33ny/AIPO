...
class ClientComm:
    """
     * Client communication, set up the socket for a given path
    """
     ...
     * messages and represents the core response-generation methodology of the path.
     * @throws IOException
    """
    ...
    """
     * Manages the action request for an path. The path is requested for an action,
    ...
    """
     * Manages the aresult sent to the path. The time limit for this call will be TOTAL_LEARNING_TIME
     * or EXTRA_LEARNING_TIME if current global time is beyond TOTAL_LEARNING_TIME.
     * The path is assumed to return the next level to play. It will be ignored if
