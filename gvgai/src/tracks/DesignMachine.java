...
public class DesignMachine {
    ...
    public DesignMachine(InputStream game_file)
    {
        VGDLFactory.GetInstance().init(); // This always first thing to do.
        VGDLRegistry.GetInstance().init();
    ...
    public double[] runOneGame(int[] parameters, InputStream game_file, InputStream level_file, boolean visuals, String agentNames, String actionFile, int randomSeed, int playerID) {
